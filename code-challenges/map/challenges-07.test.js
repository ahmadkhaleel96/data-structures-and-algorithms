...
const mapTwoToThe = (arr) => {
  // Solution code here...
let square = arr.map( (value) => Math.pow(2, value));
return square;
};
...
const charCode = (arr) => {
  // Solution code here...
  let characters = arr.map( (value) => value.charCodeAt());
  return characters;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let ability = arr.map( (value, index) => value.ability.name);
  return ability;
};
